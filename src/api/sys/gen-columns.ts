...
export const getGenColumns = (data?: object) => {
  return http.request<Result<GenColumns>>("post", "/api/v1/sys/gen-columns/get", {
    data
  });
};
...
export const createGenColumns = (data?: object) => {
  return http.request<Result<GenColumns>>("post", "/api/v1/sys/gen-columns/create", {
    data
  });
};
...
export const updateGenColumns = (data?: object) => {
  return http.request<Result<GenColumns>>("post", "/api/v1/sys/gen-columns/update",{
    data
  });
};
...
export const delGenColumns = (data?: object) => {
  return http.request<Result<GenColumns>>("post", "/api/v1/sys/gen-columns/del",{
    data
  });
};
